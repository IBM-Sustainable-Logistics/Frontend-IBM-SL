    ...
    >
      <section className="terms-and-conditions px-4 sm:px-8 lg:px-16">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>Using a buying agent or purchasing agent to make purchases on the site.</li>
          <li>Using the site to advertise or offer to sell goods and services.</li>
          <li>Circumventing, disabling, or otherwise interfering with security-related features of the site, including features that prevent or restrict the use or copying of any Content or enforce limitations on the use of the site and/or the Content contained therein.</li>
          ...
          <li>Deciphering, decompiling, disassembling, or reverse engineering any of the software comprising or in any way making up a part of the site.</li>
          ...
          <li>Copying or adapting the site’s software, including but not limited to Flash, PHP, HTML, JavaScript, or other code.</li>
          ...
          <li>Except as may be the result of standard search engine or Internet browser usage, using, launching, developing, or distributing any automated system, including without limitation, any spider, robot, cheat utility, scraper, or offline reader that accesses the site, or using or launching any unauthorized script or other software.</li>
