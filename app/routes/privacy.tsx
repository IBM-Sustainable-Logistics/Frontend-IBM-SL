    ...
    >
      <Hero
        jsx={(<>
          ...
          <p className='text-2xl lg:text-[1.5vw] min-[1800px]:leading-[3.5rem]'>
            The only information that we keep about you is the information needed to allow you to log into your account and save your projects.
      ...
      <section className="privacy-policy px-4 sm:px-8 lg:px-16">
        ...
        <h3 className="text-2xl font-semibold mt-6 mb-2">3. Disclosure of Your Information</h3>
        ...
        <h3 className="text-2xl font-semibold mt-6 mb-2">4. Security of Your Information</h3>
        <p>We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.</p>

        <h3 className="text-2xl font-semibold mt-6 mb-2">5. Policy for Children</h3>
        ...
        <p>You have the right to access, update, or delete the information we have on you. If you are unable to perform these actions yourself, please contact us to assist you.</p>
        <ul className="list-disc list-inside">
        ...
        <p>
          ...
          Email: <a href="mailto:tanda@itu.dk">tanda@itu.dk</a><br />
        </p>
      </section>
    </main>
  );
