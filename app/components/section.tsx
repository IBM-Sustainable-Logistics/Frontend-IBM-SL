...
const Section: React.FC<SectionProps> = ({ backgroundColor, textColor }) => {
    ...
    >
      <div className='text-center mx-[2rem] lg:mx-[12rem] my-[2.5rem] flex flex-col gap-2'>
        ...
        <p className='text-[1.1rem] md:px-[5rem] lg:px-[2rem] text-left lg:text-[1.2rem] '>
          ...
          to measure their CO2 emissions. This will help companies report their
          environmental impact more accurately, and together we can work towards
