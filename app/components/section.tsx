...
const Section: React.FC<SectionProps> = ({ backgroundColor }) => { // Corrected the props destructuring
    const message = "Empowering the future of sustainable logistics with IBM";
  return (
    <section
      id='hero'
      className='w-full py-20	lg:p-0'
      style={{ backgroundColor: backgroundColor }}
    >
      <div className="text-center mx-[2rem] lg:mx-[18rem] lg:my-[2.5rem] flex flex-col gap-2">
         <h1 className='text-4xl lg:text-[2.25vw] leading-10 font-bold'>
        Our vision</h1>
      <p className="text-2xl lg:text-[1.2vw]">
